...
public class FrogSnakeGame{
    ...
    private void drawArenaBug(){
        ...
        UI.drawString(("Light frog score: "+(this.count1)),480,60);
        UI.drawString(("Dark frog score: "+(this.count2)),480,120);
        UI.println(count3);
        UI.setLineWidth(1);
